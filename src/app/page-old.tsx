...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/10 via-background to-secondary/10">
        ...
        <div className="mt-24 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card className="text-center">
            <CardHeader>
              ...
              <CardDescription>
                Access comprehensive tools for client management, assessments, and treatment planning.
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card className="text-center">
            <CardHeader>
              ...
              <CardDescription>
                Oversee operations, manage teams, and track organizational performance metrics.
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card className="text-center">
            <CardHeader>
              ...
              <CardDescription>
                Full system control with user management, settings, and comprehensive analytics.
              </CardDescription>
            </CardHeader>
          </Card>
        </div>
          ...
          <Card className="max-w-2xl mx-auto bg-primary/5 border-primary/20">
            <CardHeader>
              ...
              <CardDescription className="text-lg">
                Join thousands of families and professionals using SPARKS to improve therapeutic outcomes.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Link href="/signup">
      ...
      {/* Footer */}
      <footer className="border-t border-border bg-card/50 backdrop-blur mt-24">
