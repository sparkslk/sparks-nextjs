                    ...
                    <div className="hidden lg:block space-y-8">
                        <div className="text-center lg:text-left">
                            ...
                            <p className="text-xl text-muted-foreground leading-relaxed">
                                Connect with Sri Lanka&apos;s premier ADHD support platform
                            </p>
                        </div>
                        ...
                        <div className="space-y-6">
                            <div className="flex items-start gap-4 p-4 rounded-lg bg-card/50 border">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground text-sm">
                                        Get tailored ADHD support designed specifically for Sri Lankan families
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4 p-4 rounded-lg bg-card/50 border">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground text-sm">
                                        Connect with other families and share experiences in a supportive environment
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4 p-4 rounded-lg bg-card/50 border">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground text-sm">
                                        Access comprehensive ADHD education and coping strategies
                                    </p>
                                </div>
                            </div>
