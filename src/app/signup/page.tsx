...
const roleOptions = [
    { value: UserRole.NORMAL_USER, label: "Normal User", description: "Regular user access" },
    { value: UserRole.PARENT_GUARDIAN, label: "Parent/Guardian", description: "Manage family accounts and children" },
    { value: UserRole.THERAPIST, label: "Therapist", description: "Provide therapeutic services" },
    { value: UserRole.MANAGER, label: "Manager", description: "Manage team and operations" },
