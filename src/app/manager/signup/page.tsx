                    ...
                    <div className="hidden lg:block space-y-8">
                        <div className="text-center lg:text-left">
                            ...
                            <p className="text-xl text-muted-foreground leading-relaxed">
                                Oversee operations and coordinate teams within your organization
                            </p>
                        </div>
                        ...
                        <div className="space-y-6">
                            <div className="flex items-start gap-4 p-4 rounded-lg bg-card/50 border">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground text-sm">
                                        Coordinate therapists, staff, and resources within your department
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4 p-4 rounded-lg bg-card/50 border">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground text-sm">
                                        Track team performance and operational metrics for your organization
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4 p-4 rounded-lg bg-card/50 border">
                                ...
                                <div>
                                    <h3 className="font-semibold text-foreground mb-2">Resource Scheduling</h3>
                                    <p className="text-muted-foreground text-sm">
                                        Manage schedules, appointments, and resource allocation efficiently
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4 p-4 rounded-lg bg-card/50 border">
                                ...
                                <div>
                                    <h3 className="font-semibold text-foreground mb-2">Communication Hub</h3>
                                    <p className="text-muted-foreground text-sm">
                                        Facilitate communication between teams, patients, and families
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <CardHeader className="space-y-4 text-center">
                                ...
                                <div>
                                    ...
                                    <CardDescription className="text-muted-foreground">
                                        Create your manager account to oversee SPARKS operations
                                    </CardDescription>
                                </div>
                            </CardHeader>
