    ...
    React.useEffect(() => {
        const fetchTherapistData = async () => {
            try {
                ...
                const requestsResponse = await fetch("/api/therapist/session-requests/count")
                            ...
                            <SidebarMenuButton size="lg" asChild>
                                <div className="flex items-center gap-2">
                                    ...
                                    <div className="grid flex-1 text-left text-sm leading-tight">
                                        <span className="truncate font-semibold">Sparks Therapy</span>
                            ...
                            <DropdownMenu>
                                ...
                                >
                                    <DropdownMenuItem asChild>
                                        <a href="/therapist/profile" className="flex items-center gap-2">
                                            <User className="size-4" />
                                            Profile
                                        </a>
                                    </DropdownMenuItem>
                                    <DropdownMenuItem asChild>
                                        <a href="/therapist/settings" className="flex items-center gap-2">
