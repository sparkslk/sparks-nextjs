...
const DonationModal: React.FC<DonationModalProps> = ({ isOpen, onClose, donations }) => {
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      >
        <div style={{
          ...
          <DialogTitle style={{ color: 'white', fontWeight: 700, fontSize: '1.25rem', margin: 0 }}>All Donations</DialogTitle>
        </div>
              ...
              donations.map((donation) => (
                <div key={donation.id} className="flex items-start justify-between py-2">
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-gray-400">Received: {donation.timeAgo}</div>
                  </div>
